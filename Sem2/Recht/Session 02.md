...
* Schadensersatz: §§823 ff. BGB
  * Wichtig: §§826, 831 BGB
* Anspruch auf Abwehr öffentlicher Äußerungen: §1004 BGB

## Unerlaubte Handlungen
* Deliktsrecht regelt Ausgleich für Schäden, die eine Person einer anderen widerrechtlich zufügt
* Beispiel: *Beim Rückwärtsfahren fährt A den Gartenzaun des B um*
* Deliktische Ansprüche stehen oftmals neben vertraglichen Ansprüchen
* Widerlegen kennt man "Exkulpieren"

### Gefährdungshaftung
* Kein Verschulden nötig
* Haftung für Folge gefährlichen Tuns
...
* Verschulden
* Schaden
* Kein Ausschluss, keine Verjährung

### Rechtsgutverletzung
* Rechtsgüter und Rechte sind in §623 I BGB explizit aufgezählt
  * **Leben**: Vernichtung der physischen Existenz
  * **Körper und Gesundheit**: Eingriff in die körperliche Unversertheit bzw. in die inneren Lebensvorgänge
  * **Eigentum**
...
* Nur absolute Rechte
  ...
  * Z. B. Besitz, Eigentum
* Schuldrechtliche Forderung ist nicht ggü jedem geltend, nur gegen Forderungsgegner
* Zwei spezielle Rechte sind Rechte im sonstigen Sinne
  * Persönlichkeitsrecht
  * Recht am eingerichteten und ausgeübten Gewerbebetrieb
  * Die beiden sind Rahmenrechte, bei deren Verletzung die Rechtswidrigkeit anders als bei anderen positiv festgestellt werden muss
* Ebenso Anwartschaftsrecht
  * Beispiel
    * S beschädigt PKW, den K von V unter Eigentumsvorbehalt gekauft hat
    * K hat bisher nur 12k von 20k€ bezahlt
    * K kann von S nur diese 12k verlangen
  * Daraus folgt, dass unter §823 I BGB auch der Besitz fällt
* Arbeitsplatz ist kein sonstiges Recht
  * Wenn man rausgemobbt wird, hat man keinen Anspruch wegen Arbeitsplatz

#### Recht am eingerichteten und ausgeübten Gewerbebetrieb
* Umfasst alles, was den Wert eines Betriebes ausmacht
* Beispiele
  * Fuhrpark
  * Betriebsgebäude
  * Guter Name des Unternehmens
  * Kundenstamm

##### Voraussetzungen des Anspruchs aus §823 I BGB
* Aus dem **RaeuaGb**
* **Anwendbarkeit**: Nur wenn kein anderes Recht greift
* **Gewerbebetrieb**:
  * Muss sich um Gewerbebetrieb handeln
  * Darunter fallen auch Freiberufler
* **Betriebsbezogenheit**: Eingriff muss betriebsbezogen sein
  * Muss sich gegen Rechtsgüter richten, die Privatpersonen nicht zustehen können
  * Beispiel: *A und B treten immer gemeinsam auf. X verletzt A. B hat keinen Anspruch ggü. X, da körperliche Verletzungen jeden treffen können*
...
#### Allgemeines Persönlichkeitrecht
* Vorschrift: §823 I iVm Art. 2, Art. 1 GG
  * Recht auf Achtung und Entfaltung der eigenen Persönlichkeit
* Hauptrechtsgutverletzung sind falsche und beleidigende Darstellung sowie Eingriffe in die Privat- und Intimsphäre
* Abgrenzung: Tatsachen und Werturteile
  * **Tatsachen**: Zustände oder Vorgänge aus Gegenwart und Vergangenheit, die dem Beweis zugänglich sind
  * **Werturteile**: Auseinandersetzen und Meinen im Rahmen einer Äußerung; Richtigkeit ist unerheblich
* Widerruf
  * Bei negativen Werturteilen besteht kein Anspruch auf Widerruf
  * Bei falschen Tatsachen schon
* Abwägung der Rechtswidrigkeit
  * Welche Sphäre wird verletzt?
    * Eingriff in die Individualsphäre (wenig schlimm)
    * Eingriff in die Privatsphäre (schlimm)
    * Eingriff in die Intimsphäre (am schlimmsten)
  * Nimmt die eingreifende Person ein berechtigtes Interesse wahr?
    * Z. B. legitimes Informationsinteresse der Öffentlichkeit
  * Hat die betroffene Person vorher selbst freiwillig Details aus dem Privatleben etc. preisgegeben?
  * Ist der Kernbereich des allgemeinen Persönlichkeitsrechts betroffen?

### Verkehrssicherungspflichten
* Unterlassen reicht aus
* Verkehrssicherungspflicht verpflichtet zum Handeln
* Definition: *Wer eine Gefahrensquelle für andere schafft oder unterhält, muss die Vorkehrungen treffen, die erforderlich und zumutbar sind, um Gefahren für andere auszuschließen*
* Fälle sind:
  * Verkehrseröffnung
    * Wer Verkehr auf bestimmten Grundstücken für die Öffentlichkeit ermöglicht, muss alle Gefahren im Zusammenhang mit bestimmungsgemäßen Gebrauch der dort angebotenen Geräte ausschließen
    * Beispiel: *Sportstudio, Freizeitpark*
  * Sachbeherrschung
    * Wer eine Sache beherrscht, ist zur Abwehr der von ihr drohenden Gefahren für andere verpflichtet
    * Beispiel: *Auto, Waffe*
  * Berufliche Stellung
    * Wenn eine berufliche Tätigkeit eine bestimmte Gefahr mit sich bringt, können sich besondere Verkehrssicherungspflichten ergeben
    * Beispiel: *Wachdienst sorgt dafür, dass kein Einbruch passiert*
  * Inverkehrbringen gefährlicher Sachen
    * Produzenten trifft eine VSP zur Verhinderung von Schäden durch sein Produkt
* Aufbau Prüfung von VSP
  * **Bestehen** einer VSP
  * Bestehen der VSP **ggü dem Verletzten**
  * VSP muss **verletzt worden sein**
  * Schaden muss auch **kausal** durch Verletzung der VSP entstanden sein
...
* Verrichtungsgehilfe
  * Definition: Verrichtungsgehilfe ist, wer im Interesse des Geschäftsherrn und mit dessen Wissen und Wollen tätig wird und dabei weisungsgebunden ist. Weisungsgebundenheit stellt den Unterschied zu §278 dar
  * Unerlaubte Handlung: Rechtswidrige Handlung nach §823 I BGB
  * Verschulden des Verrichtungsgehilfen ist unerheblich
  * Schaden
